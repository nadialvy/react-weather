const CardSubDetailWeather = ({ iconPath, alt, desc, title }) => {
  return (
    <div className="w-1/4 border border-slate-300 bg-slate-50 transition-all rounded-lg shadow-sm p-4 hover:-translate-y-3 hover:shadow-lg hover:cursor-pointer">
